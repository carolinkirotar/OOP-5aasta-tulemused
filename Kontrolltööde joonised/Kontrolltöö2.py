...
ax = sns.violinplot(data=df_copy, x="aasta", y=focused_row, inner="quart", linewidth=1, scale="count", color='#f8765c')
...
for i in range(len(means)):
    ...
    box_plot.annotate(text, xy=(i, means[i]), xytext=(i+0.04, means[i]-2.0), ha='left', fontsize='8',
...
plt.ylim(-0.3, 17)
plt.ylabel('Kontrolltöö 2', fontweight='bold')
